...
export const GET: RequestHandler = async ({ params }) => {
	...
	try {
		const r = await getComicSynopsisBySID(db, { comicCode: params.code, rid: params.rid });
...
export const PATCH: RequestHandler = async ({ params, request }) => {
	...
	try {
		...
		const r = await updateComicSynopsisBySID(db, { comicCode: params.code, rid: params.rid }, v, a);
...
export const DELETE: RequestHandler = async ({ params, request }) => {
	...
	try {
		...
		await deleteComicSynopsisBySID(db, { comicCode: params.code, rid: params.rid }, a);
